...
module braille_cell(x_cell, y_cell, z_cell)
{
    ...
    translate([(x_out/2)-(x_cell/2), (1.6*r_front), (1.6*r_front)])
    {
...
{
    translate([(x_out/2)-(x_slid/2),(1.5*r_front+gap)+(y_cell/2), (1.7*r_front)])
    {
        lid_front(x_guide, y_guide, r_guide);
    }
    
    translate([x_out-(x_slid/10)- x_guide,(1.5*r_front+gap)+(y_cell/2), (1.7*r_front)])
    {
        lid_front(x_guide, y_guide, r_guide);
    }
}
...
{
    translate([r_front, (0.45)*r_front, -(0.5)*z_bplate])
    {
...
module lid_v3_att3()
{
    difference()
    {
        ...
        #translate([20, r_cut+7, r_front/4])cube([x_out-40, r_front, r_front+10]);
    }
    difference()
    {
